...
%   plot(TzengInf(:,1),TzengInf(:,2),'k>-','MarkerFaceColor','k')
  ...
  plot(rArr*1000,uArr(1,:),'b-o')
  plot(rArr*1000,uArr(2,:),'r-o')
  plot(rArr*1000,uArr(3,:),'k-o')
...
%   plot(TzengInf(:,1),TzengInf(:,2),'k>-','MarkerFaceColor','k')
  ...
  plot(rArr*1000,sArr(3,:,2)*10^-6,'r-o')
  plot(rArr*1000,sArr(3,:,3)*10^-6,'k-o')
...
%   plot(TzengInf(:,1),TzengInf(:,2),'k>-','MarkerFaceColor','k')
  ...
  plot(rArr*1000,sArr(1,:,2)*10^-6,'r-o')
  plot(rArr*1000,sArr(1,:,3)*10^-6,'k-o')
